package com.mvvm.fanny.lib_components.view;
...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener{
    ...
    public VerificationCodeView(Context context, @Nullable AttributeSet attrs) {
        ...
        mEtTextBg = typedArray.getResourceId(R.styleable.vericationCodeView_vcv_et_bg, R.drawable.shape_vcv_et_radius_fff);
    ...
    private void focus() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (editText.getText().length() < 1) {
                ...
                editText.setBackground(mContext.getDrawable(R.drawable.shape_vcv_et_radius_0f67b0));
                editText.setCursorVisible(false);
                if (i == count - 1) {
                    editText.requestFocus();
                }
    ...
    private void backFocus() {
        ...
        for (int i = mEtNumber - 1; i >= 0; i--) {
            ...
            if (editText.getText().length() >= 1) {
                editText.setText("");
                editText.setBackground(mContext.getDrawable(R.drawable.shape_vcv_et_radius_fff));
                if (cursorVisible) {
                    editText.setCursorVisible(true);
                } else {
                    editText.setCursorVisible(false);
    ...
    public int getmEtSpacing() {
        return mEtSpacing;
    }

    public void setmEtSpacing(int mEtSpacing) {
        this.mEtSpacing = mEtSpacing;
    }

    public int getmEtBisectSpacing() {
        return mEtBisectSpacing;
    }

    public void setmEtBisectSpacing(int mEtBisectSpacing) {
        this.mEtBisectSpacing = mEtBisectSpacing;
    }
    ...
    public int getmViewMargin() {
        return mViewMargin;
    }

    public void setmViewMargin(int mViewMargin) {
